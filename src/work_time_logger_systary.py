        ...
        while not finished:
            ...
            if working_time > self.reference_time:
                if not msg_box_showed:
                    print(working_time)
                    wx.MessageBox("It's time to end your work.\n\n{}".format(working_time), 'Info', wx.OK | wx.ICON_INFORMATION)
                    msg_box_showed = True
...
class TaskBarIcon(wx.adv.TaskBarIcon):
    ...
    def CreatePopupMenu(self):
        menu = wx.Menu()
        create_menu_item(menu, self.log_label, self.log_work)
        create_menu_item(menu, 'Working time', self.show_working_time)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--stop', required=False, action='store_true', help="Use when start application.", default=False)
